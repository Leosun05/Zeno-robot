...
/**
 * gamedemo.java - class to show off our robot
...
public class gamedemo extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        if (myRobot.isConnected()) {
           ...
           // mySpeaker.speak("Hello. My name is Zeeno, nice to meet you. I want to paly a game with you. Please pay attention to the screen!"); //Wrong spelling so robot can pronounce it right!
...
//            }      
    ...
    public static void zenoSmile() 
    {
        ...
        myGoalPositions.put(left_smile, new NormalizedDouble(0.6));
        myGoalPositions.put(right_smile, new NormalizedDouble(0.6));
        // makes the robot look up
        myGoalPositions.put(neck_pitch, new NormalizedDouble(0));
        myGoalPositions.put(eyes_pitch, new NormalizedDouble(0));
        myGoalPositions.put(left_eye_yaw, new NormalizedDouble(0));
        myGoalPositions.put(right_eye_yaw, new NormalizedDouble(1));
    ...
    public static void question(){
            ...
            Boolean dance = false;
             ...
             String speakCommand = JOptionPane.showInputDialog("are you a student? Y/N");
             mySpeaker.speak("are you a student?");
            speakCommand = speakCommand.toUpperCase();
            if (speakCommand.equals("Y")) {
                speak = true;
                mySpeaker.speak("do you want to play a game?");
                String speech = JOptionPane.showInputDialog("Type something for him to say.");
                // convert to lower case
                speech = speech.toLowerCase();
            ...
            speakCommand = JOptionPane.showInputDialog("what is your name");
            speakCommand = speakCommand.toUpperCase();
            String speech2 ; 
            speech2 = JOptionPane.showInputDialog("Type something for him to say.");
            speech2 = speech2.toLowerCase(); 
            mySpeaker.speak(speech2);
        
         
           mySpeaker.speak("Demo is going to finish");
